...
namespace COM3D2.PNGPreset.Patcher
{
    public static class PNGPresetPatcher
    {
        ...
        {
            var managedAd = AssemblyLoader.LoadAssembly(
                Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), $"{MANAGED_NAME}.dll"));
            ...
            presetSaveMethDef.InjectWith(presetSaveHookMethDef,
            ...
            presetSetMethDef.InjectWith(presetSetHookMethDef, -1,
            ...
            presetListLoadMethDef.InjectWith(presetListLoadHookMethDef, -1,
                flags: InjectFlags.PassInvokingInstance | InjectFlags.PassLocals, localsID: new[] {0});
            ...
            presetLoadMethDef.InjectWith(presetLoadHookDef,
                flags: InjectFlags.ModifyReturn | InjectFlags.PassInvokingInstance | InjectFlags.PassParametersVal);
